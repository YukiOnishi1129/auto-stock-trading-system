...
const (
	GreetingService_Hello_FullMethodName             = "/auto.trading.hello.v1.GreetingService/Hello"
	GreetingService_HelloServerStream_FullMethodName = "/auto.trading.hello.v1.GreetingService/HelloServerStream"
	GreetingService_HelloClientStream_FullMethodName = "/auto.trading.hello.v1.GreetingService/HelloClientStream"
	GreetingService_HelloBiStreams_FullMethodName    = "/auto.trading.hello.v1.GreetingService/HelloBiStreams"
)
...
var GreetingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "auto.trading.hello.v1.GreetingService",
