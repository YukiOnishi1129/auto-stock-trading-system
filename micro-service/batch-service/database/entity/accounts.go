...
var AccountWhere = struct {
	...
	UserId:            whereHelperstring{field: "`accounts`.`userId`"},
	Type:              whereHelperstring{field: "`accounts`.`type`"},
	Provider:          whereHelperstring{field: "`accounts`.`provider`"},
	ProviderAccountId: whereHelperstring{field: "`accounts`.`providerAccountId`"},
...
func (r *accountR) GetUserIdUser() *User {
	if r == nil {
		return nil
	}
	return r.UserIdUser
...
var (
	accountAllColumns            = []string{"id", "userId", "type", "provider", "providerAccountId", "refresh_token", "access_token", "expires_at", "token_type", "scope", "id_token", "session_state", "oauth_token_secret", "oauth_token", "created_at", "updated_at", "deleted_at"}
	accountColumnsWithoutDefault = []string{"id", "userId", "type", "provider", "providerAccountId", "refresh_token", "access_token", "expires_at", "token_type", "scope", "id_token", "session_state", "oauth_token_secret", "oauth_token", "deleted_at"}
...
func (o *Account) UserIdUser(mods ...qm.QueryMod) userQuery {
...
func (accountL) LoadUserIdUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAccount interface{}, mods queries.Applicator) error {
	var slice []*Account
	var object *Account
	...
	if singular {
		...
		foreign.R.UserIdAccounts = append(foreign.R.UserIdAccounts, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.UserId == foreign.ID {
				...
				foreign.R.UserIdAccounts = append(foreign.R.UserIdAccounts, local)
				break
			}
		}
	}
...
// SetUserIdUser of the account to the related item.
// Sets o.R.UserIdUser to related.
// Adds o to related.R.UserIdAccounts.
func (o *Account) SetUserIdUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
	...
	if related.R == nil {
		related.R = &userR{
			UserIdAccounts: AccountSlice{o},
		}
	} else {
		related.R.UserIdAccounts = append(related.R.UserIdAccounts, o)
	}
...
func (o *Account) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to populate default values for accounts")
	}
...
func (o *Account) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to upsert for accounts")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to retrieve unique values for accounts")
	}
