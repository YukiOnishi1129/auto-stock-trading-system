...
var SessionWhere = struct {
	...
	SessionToken: whereHelperstring{field: "`sessions`.`sessionToken`"},
	UserId:       whereHelperstring{field: "`sessions`.`userId`"},
...
func (r *sessionR) GetUserIdUser() *User {
	if r == nil {
		return nil
	}
	return r.UserIdUser
...
var (
	sessionAllColumns            = []string{"id", "sessionToken", "userId", "expires", "created_at", "updated_at"}
...
func (o *Session) UserIdUser(mods ...qm.QueryMod) userQuery {
...
func (sessionL) LoadUserIdUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeSession interface{}, mods queries.Applicator) error {
	var slice []*Session
	var object *Session
	...
	if singular {
		...
		foreign.R.UserIdSessions = append(foreign.R.UserIdSessions, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.UserId == foreign.ID {
				...
				foreign.R.UserIdSessions = append(foreign.R.UserIdSessions, local)
				break
			}
		}
	}
...
// SetUserIdUser of the session to the related item.
// Sets o.R.UserIdUser to related.
// Adds o to related.R.UserIdSessions.
func (o *Session) SetUserIdUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
	...
	if related.R == nil {
		related.R = &userR{
			UserIdSessions: SessionSlice{o},
		}
	} else {
		related.R.UserIdSessions = append(related.R.UserIdSessions, o)
	}
...
func (o *Session) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to populate default values for sessions")
	}
...
func (o *Session) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to upsert for sessions")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to retrieve unique values for sessions")
	}
